...
<html lang="en" class="no-js">
	...
	<body>
		...
		<input type="submit" class = "right"  id="button1" onclick="myfunction()" value="Logout <?php include('session.php');echo $login_session;?>">
		</form>
		</div>
    <script> 
	function myfunction(){
